...
class WHILL_Data(Dataset):
    ...
    def __init__(self, data_root, conditions, config):
        ...
        for condition in conditions:
            ...
            preload_file = os.path.join(sub_root, 'huang_seq'+str(self.seq_len)+'_pred'+str(self.pred_len)+'_rp1'+str(self.rp1_close)+'_maf'+str(self.config.n_buffer*self.data_rate)+'.npy')
